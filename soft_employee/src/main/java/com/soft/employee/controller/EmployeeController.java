package com.soft.employee.controller;
...
import com.soft.common.utils.BeanMapUtils;
import com.soft.common.utils.DownloadUtils;
import com.soft.domain.employee.*;
import com.soft.domain.employee.response.EmployeeReportResult;
import com.soft.employee.service.*;
...
public class EmployeeController extends BaseController {
    ...
    public Result findOneInfo() throws Exception {
        UserCompanyPersonal info = userCompanyPersonalService.findById(this.userId);
        if(info == null) {
            info = new UserCompanyPersonal();
